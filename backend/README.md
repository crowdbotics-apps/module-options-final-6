...
## Project Structure
    ...
    ├── module_options_final_6  # Django project configurations
...
1. Clone this repo and `cd module_options_final_6`
...
2. Clone this repo and `cd module_options_final_6`
